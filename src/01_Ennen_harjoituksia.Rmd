...
Harjoituksessa asennetaan Input-ohjelmisto mobiililaitteelle ja luodaan tunnukset
...
Harjoitusohjeet on tehty Inputin suomenkieliselle käyttöliittymälle, joten olisi tarvittaessa hyvä vaihtaa mobiililaitteen käyttöliittymän kieli suomeksi, jolloin Inputin kieli on suomi.
...
Hakutuloksen pitäisi olla **Mergin maps tai Input** -sovellus.
...
Sinun tulee syöttää samat tunnukset myöhemmin myös Qgissin puolella, kun Mergin Maps-lisäosa on asennettu.
